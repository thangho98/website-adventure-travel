...
export default {
  ...
  methods: {
    loadData() {
      axios.get(this.$Api + "/tour/" + this.form.tour_id).then(response => {
        //console.log(response);
        let data = response.data;
        this.form.tour_promotion = data["tour_promotion"];
        this.form.tour_tourist_route = data["tour_tourist_route"];
        this.form.date = new Date(data["tour"]["tour_time_start"]);
      });
    },
    cancel() {
    ...
    update() {
      ...
      this.$Progress.start();
      this.form
        .put(this.$Api + "/tour/" + this.form.tour_id)
        .then(response => {
          console.log(response);
          Toast.fire({
            type: "success",
