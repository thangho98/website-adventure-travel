        ...
        <div class="row">
            <div class="col-lg-9">
                <div id="search-results">
                    <div class="title">
                        <h1>DANH SÁCH TOUR DU LỊCH HẠ LONG KHỞI HÀNH TỪ HỒ CHÍ MINH</h1>
                    </div>
...
@section('script')
<script src="{{asset('/')}}client/js/library.js" type="text/javascript" async></script>
<script src="{{asset('/')}}client/js/search.js" type="text/javascript" async></script>
@stop